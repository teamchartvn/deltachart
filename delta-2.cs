...
namespace NinjaTrader.NinjaScript.BarsTypes
{
	public class DeltarBar : BarsType
	{
		...
		protected override void OnStateChange()
		{
			...
			{
				Name			= "Delta Bar";
				BarsPeriod		= new BarsPeriod { BarsPeriodType = (BarsPeriodType)99812, Value = 100 };
			...
			{
				Name = string.Format(Core.Globals.GeneralOptions.CurrentCulture, "DELTA", BarsPeriod.Value, (BarsPeriod.MarketDataType != MarketDataType.Last ? string.Format(" - {0}", Core.Globals.ToLocalizedObject(BarsPeriod.MarketDataType, Core.Globals.GeneralOptions.CurrentUICulture)) : string.Empty));
